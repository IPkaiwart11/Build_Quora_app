          ...
          <div className='containerHeader'>
           <div className='parentHeader'>  
                ...
                <div className='quoraLogo singleicon'>
                 <NavLink to='./QuoraBody' id='Quora'>QUORA</NavLink>
                </div>
                <div className='homeIcon singleicon'>
                    <NavLink to='./QuoraBody'><HomeIcon sx={{ fontSize: 35,color: grey[600] }}/></NavLink>      
                </div>
                <div className='followingIcon singleicon'>
                      <FeaturedPlayListIcon sx={{ fontSize: 30,color: grey[600] }}/>
                </div>
                <div className='ansIcon singleicon'>
                <QuickreplyIcon sx={{ fontSize: 30,color: grey[600] }}/>
                </div>
                <div className='spaceIcon singleicon'>
                 <Groups2Icon sx={{ fontSize: 35,color: grey[600] }}/>
                </div>
                <div className='notificationIcon singleicon'>
                    <NavLink to='/Notification'> <NotificationsIcon sx={{ fontSize: 35,color: grey[600] }}/> </NavLink>       
                </div>
                <div className='headerSearchContainer singleicon'>
                        <div>
                        <button> <SearchIcon sx={{ fontSize: 30 }}/> </button>
                      <input className='headerSearch' singleicon type="text" placeholder='search Quora' />
                              </div>      
                </div>
                <div onClick={closeQuora} className='LogOut singleicon'><button >LogOut</button></div>
