     ...
     <PostContainer />
      ...
      <div className='postContainer'>
        ...
        <Avatar>
          <img src="/images/hritik.jpeg" alt="" />
            ...
            <div className='ppn'>
              <div className='hName'>
                 <div><b>Hritik's Universe</b></div>
                 <div className='follow'> <span>*</span>Follow</div>
              </div>
              <div>Answered by Hritik Talreja <span>*</span><span>1y</span></div>
              </div>
            </div>
        ...
        <div><h4>Which screenshot deserve 9888k views?</h4></div>
        <div ><img className='post_images' src="/images/post4.jpeg " alt="" /></div>
        ...
        <div className='pfooter1'>
          ...
          <div className='pReaction'>
            <div className='voteupvote'>
                 ...
                 <div className='downvote tooltip'><button onClick={unvoteg}><GetAppIcon/>{unvote1}</button><span className="tooltiptext">downvote</span></div>

            </div>
            <div  className='pFc'>
              <div className='tooltip' onClick={Opencomment1}><ModeCommentIcon/><span className="tooltiptext">Answer</span></div>
              <div>7</div>
              </div>
            <div className='pFc'>
              <div className='tooltip'><ShareIcon/><span className="tooltiptext">share</span></div>
            <div>54</div>
            </div>
          </div>
          </div>
        ...
        <div className="pComment">
          ...
          <Avatar><img src="/images/profile2.webp" alt="" /></Avatar>
          <div className='flex2'><input type="text" value='Add a comment'/></div>
          <div className='flex3'><button type="submit">Add comment</button></div>
        </div>:null}
      ...
      <div className='postContainer'>
        <div className='pHeader1'>
          <div className='pHeader2'>
        {/* <div className='svg-icon blur-effect'> <Avatar></Avatar></div> */}
        <Avatar><img src="/images/cors.jpeg" alt="" /></Avatar>
            <div className='ppn'>
              <div className='hName'>
                 <div><b>Cory Watts </b></div>
                 <div className='follow'> <span>*</span>Follow</div>
              </div>
              <div>Software Developer (2019-present) <span>*</span><span>4h ago</span></div>
              </div>
        ...
        <div><h4>Which screenshot deserves 200k view and comments?</h4></div>
        {/* <div><p></p></div> */}
        <div ><img className='post_images' src="/images/post2.jpeg" alt="" /></div>
        <div className='pfooter1'>
          <div className='pfooter2'>
          <div className='pReaction'>
            <div className='voteupvote'>
                 ...
                 <div className='downvote tooltip'><button onClick={unvoteh}><GetAppIcon/>{unvote2}</button><span className="tooltiptext">downvote</span></div>

            </div>
            <div  className='pFc'>
              <div className='tooltip' onClick={Opencomment2}><ModeCommentIcon/><span className="tooltiptext">Answer</span></div>
              <div>100</div>
              </div>
            <div className='pFc'>
              <div className='tooltip' ><ShareIcon/><span className="tooltiptext">share</span></div>
